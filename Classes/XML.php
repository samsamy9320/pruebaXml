...
class XML
{
    ...
    //?Se necesita llamar el metodo desde afuera asi que se decide hacerlo public
    /*Se cambia en base a lo siguiente se encuenta en la documentación oficial:
        Members declared as private may only be accessed by the class that defines the member
    */
    public function setAtribute($attr, $value)
    {
        //? Faltaba el atributo que se iba a sobreescribir
